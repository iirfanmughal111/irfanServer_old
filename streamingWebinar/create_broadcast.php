...
if ($client->getAccessToken()) {
  try {
    ...
    $broadcastSnippet->setTitle('New Broadcast from api');
    $broadcastSnippet->setScheduledStartTime('2022-12-20T13:00:00.000000Z');
    $broadcastSnippet->setScheduledEndTime('2022-12-20T14:00:00.000000Z');

    // Create an object for the liveBroadcast resource's status, and set the
    // broadcast's status to "public".
    ...
    $streamSnippet->setTitle('New Stream from api');
